                        ...
                        <div class="block block-rounded block-bordered mb-4">
                            ...
                            <div class="block-content py-3 px-4">
                                ...
                                @else
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="alert alert-success bg-success-light border-0 py-2 px-3 mb-0 d-flex align-items-center">
                                                <i class="fa fa-check-circle me-2"></i>
                                                <span>Kunci Jawaban: <strong>{{ $question->correct_answer }}</strong></span>
                                            </div>
                                        </div>
                                    </div>
                                @endif
