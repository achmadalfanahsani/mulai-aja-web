        ...
        <div class="block block-rounded block-themed">
            <div class="block-header block-header-default bg-primary-dark">
                ...
                <div class="block-options">
                    <a href="{{ route('question-packages.questions.index', [$questionPackage->id, 'type' => request('type')]) }}" class="btn btn-sm btn-alt-secondary">
                ...
                <form action="{{ route('question-packages.questions.store', $questionPackage->id) }}" method="POST" enctype="multipart/form-data" class="py-3">
                    ...
                    <div id="options-container">
                        ...
                        <div id="dynamic-options">
                            @php
                                $defaultOptions = ['A' => 1, 'B' => 2, 'C' => 3, 'D' => 4, 'E' => 5];
                                $oldOptions = old('options', $defaultOptions);
                                ...
                                <div class="row mb-3 align-items-center option-row" data-label="{{ $label }}">
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input multiple-choice-input" type="radio" name="correct_answer" id="correct_{{ $label }}" value="{{ $label }}" {{ old('correct_answer') == $label ? 'checked' : ($index == 0 ? 'checked' : '') }}>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <a href="{{ route('question-packages.questions.index', [$questionPackage->id, 'type' => request('type')]) }}" class="btn btn-alt-secondary">Batal</a>
